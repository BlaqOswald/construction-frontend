  ...
  return (
    <MainLayout>
      <div className="p-6 bg-gray-50 min-h-screen">
        ...
        {/* HEADER */}
        <div className="flex flex-col md:flex-row justify-between md:items-center gap-4 mb-8 print:hidden">
          <div>
          ...
          <div className="flex gap-3">
            <select
              className="border border-gray-300 px-4 py-2 rounded-lg bg-white shadow-sm focus:outline-none"
              value={month}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <Card
            ...
            value={report.summary.subcontractorCost}
          />
...
const Section = ({ title, children }: any) => (
  <div className="mb-8 bg-white shadow-sm border border-gray-100 rounded-xl overflow-hidden">
...
const Td = ({ children }: any) => (
  <td className="px-4 py-3 border-b text-gray-700">{children}</td>
);